export default function ManinSectionFooter() {
  return (
    <div className="pt-[40px] pb-8">
      <nav className="pb-[20px] pt-2">
        <div className="mt-8">
          <div className="flex">
            <div className="mb-8 mr-6  basis-1/5">
              <ul className="main-footer text-[#b3b3b3]">
                <p className="font-bold text-white">Company</p>
                <li>
                  <a href="">
                    Impressum/ <br /> Transparenzinformation
                  </a>
                </li>
                <li>
                  <a href="">About</a>
            ...
            <div className="mb-[40px] flex justify-end basis-1/5 ml-auto">
              <span className="inline pr-4">
                <a
                  aria-label="Instagram"
                  title="Instagram"
                  href="https://instagram.com/spotify"
                  className="w-[40px] h-[40px] rounded-full flex justify-center items-center bg-[#292929] hover:bg-[#727272] cursor-default"
                >
                  <svg
                    role="img"
                    height="16"
        ...
        <hr className="mb-6" />
        <div className="pt-4 text-[#b3b3b3]">
          <p>© 2024 Spotify AB</p>
        </div>
      </nav>
    </div>
